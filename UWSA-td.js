...
$('#global_nav_profile_link').click(function () {
    ...
    setTimeout(function () {
        ...
        if ($popupPanelList.find('.myMediaLink').length === 0) {
            ...
            $popupPanelList.append('<li class="ic-NavMenu-list-item myMediaLink"><a href="' + location.origin + '/users/' + ENV.current_user_id + '/external_tools/36" class="ic-NavMenu-list-item__link">My Media</a>');
